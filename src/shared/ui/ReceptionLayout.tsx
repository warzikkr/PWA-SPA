...
export function ReceptionLayout() {
  ...
  const navItems = [
    { to: '/reception', label: t('menu.dashboard'), end: true },
    { to: '/reception/clients', label: t('menu.clients') },
  ];
    ...
    <div className="h-full flex bg-brand-light">
      ...
      <nav className="w-56 bg-white border-r border-brand-border flex flex-col shrink-0">
        <div className="p-4 border-b border-brand-border">
          <h1 className="font-serif text-xl font-bold text-brand-dark">Spa Reception</h1>
        </div>
